...
package com.thinkgem.jeesite.common.utils.oss;
...
public class HelloOSS {
    ...
    private static String accessKeyId = "LTAIRh2bYF4tXUwa";
    private static String accessKeySecret = "740ui17o8M7sa6xpOJ9wORGayyRZvZ";

    // Bucket用来管理所存储Object的存储空间，详细描述请参看“开发人员指南 > 基本概念 > OSS基本概念介绍”。
    // Bucket命名规范如下：只能包括小写字母，数字和短横线（-），必须以小写字母或者数字开头，长度必须在3-63字节之间。
    private static String bucketName = "ueditor-jeestie-test";
...
//        PropertyConfigurator.configure("conf/log4j.properties");
        ...
        try {
            ...
            ossClient.putObject(bucketName, fileKey, new File("d://UEditorController-for-aliyun-OSS-1.4.3.jar"));
